...
@section('content')
 ...
 <div class="content ">
        ...
        <table id="users" class="table table-custom table-lg">
            ...
            <tr>
                ...
                <td>
                    <a href="#">
                        <figure class="avatar me-3">
                            <img src="../../assets/images/user/women_avatar4.jpg"
                                 class="rounded-circle" alt="avatar">
                        </figure>
                        Steven Preuvost
                    </a>
            ...
            <tr>
                ...
                <td>
                    <a href="#">
                        <figure class="avatar me-3">
                            <img src="../../assets/images/user/women_avatar5.jpg"
                                 class="rounded-circle" alt="avatar">
                        </figure>
                        Mariann Pepperrall
                    </a>
            ...
            <tr>
                ...
                <td>
                    <a href="#">
                        <figure class="avatar me-3">
                            <img src="../../assets/images/user/man_avatar5.jpg"
                                 class="rounded-circle" alt="avatar">
                        </figure>
                        Erl Srutton
                    </a>
    ...
    <!-- ./ content -->
{{-- @extends('backend.admin.layout.footer') --}}
@endsection