...
<!-- Mirrored from vetra.laborasyon.com/demos/default/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 Jun 2022 17:29:45 GMT -->
<head>
    <meta charset="UTF-8">
                ...
                <div class="row g-0">
                    <div class="col">
                        <div class="row">
                            <div class="col-md-10 offset-md-1">
                                ...
                                <form action="{{route('login.post')}}" method="post" class="mb-5">
                                    @csrf
                                    <div class="mb-3">
                    ...
                    <div class="col d-none d-lg-flex border-start align-items-center justify-content-between flex-column text-center">
                        ...
                        <div>
                            ...
                            <a href="{{route('view.registration')}}" class="btn btn-primary">Sign Up</a>
                        </div>
...
<!-- Mirrored from vetra.laborasyon.com/demos/default/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 Jun 2022 17:29:46 GMT -->
</html>
